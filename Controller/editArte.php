...
$sql = "UPDATE  tb_artes_pedido SET  artTipo='$artTipo', artDescripiton='$artDescripiton', artEntreg='$artEntreg', artValue='$artValue' WHERE artId='$artId'";
$update = mysqli_query($conexao, $sql);

if($update == true){
	$_SESSION['arteUpdateOk'] = "Pedido de arte atualizado com sucesso!";
}else{
}
  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="mt" id="link-pag">
            <a href="../View/dashboard.php"  id="link-pag">
              <i class="fa fa-dashboard"></i>
              <span>Dashboard</span>
              </a>
          </li>
           <li class="mt" id="link-pag">
            <a href="../View/dashboardPedido.php"  id="link-pag">
              <i class="fa fa-pencil-square"></i>
              <span>Pedidos Artes</span>
              </a>
          </li>
          <li class="mt"  id="link-pag">
            <a href="../View/admin.php"  id="link-pag">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mb">
         <div class="col-lg-12">
              <?php if(isset($_SESSION['arteUpdateOk'])){?>
          <div class="alert alert-success"><?= $_SESSION['arteUpdateOk'];?> 
          <a href="../View/dashboardView.php?clientId=<?= $client->getClientId();?>">
          <button class="btn btn-success">Ok</button>
          </a>
        </div>
          <?php unset($_SESSION['arteUpdateOk']); }?>
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Cliente
                <div class="pull-right">
                  Status da ultima Arte 
                  <?php if($result['status'] == 1){?>
                  <button class="btn btn-info btn-xs">Entregue</button>
                <?php }elseif($result['status'] == 2){?>
                  <button class="btn btn-warning btn-xs">Em execução</button>
                <?php }elseif($result['status'] == 3){?>
                  <button class="btn btn-danger btn-xs">Não Entregue</button>
                <?php }else{ ?>
                <button class="btn btn-default btn-xs">Status Ok</button>
              <?php 
                }
                if(isset($result['status'])){?>
                <i class=" fa fa-trash" id="icon-del-view" data-toggle="modal" data-target="#myModalDelStatus<?= $result['statusId'];?>"></i>
              <?php }else{?>
                <?php }?>
              ...
              <h4 class="mb"><i class="fa fa-angle-right"></i> Pedido 
                ...
                <button class="btn btn-success" data-toggle="modal" data-target="#myModalStatus">Inserir Status</button>
              <?php }else{?>
                  <button class="btn btn-primary" data-toggle="modal" data-target="#myModalAltStatus">Alterar Status</button>
                <?php }?>
                </div>
              </h4>
              <!-- Modal -->
                  ...
                  <div class="modal fade" id="myModalStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <form class="form-horizontal style-form" action="../Controller/insertStatus.php?clientId=<?= $client->getClientId();?>" method="post">
                              <div class="form-group">
                   ...
                   <!-- fim Modal -->
                   <!-- Modal -->
                  <div class="modal fade" id="myModalAltStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header" id="model-painel">
                          ...
                          <div class="modal-body">
                              <form class="form-horizontal style-form" action="../Controller/editStatus.php?clientId=<?= $client->getClientId();?>" method="post">
                                 <div class="form-group">
                                <label class="col-sm-4 col-sm-4 control-label">ID </label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="statusId"
                                  value="<?= $result['statusId']?>">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-sm-4 col-sm-4 control-label">Status: </label>
         ...
         <!-- Modal -->
                    <div class="modal fade" id="myModalDelStatus<?= $result['statusId'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header" id="model-painel">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Não Cancelar</button>
                            <a href="../Controller/deleteStatus.php?statusId=<?= $result['statusId'];?>">
                            <button type="button" class="btn btn-success">Sim deletar</button>
                            </a>
                          </div>
                        </div>
